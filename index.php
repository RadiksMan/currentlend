		...
		<div class="lube-tabs tabs-top-main">
			<div class="mbox">
				<div class="lube-tabs-top-nav-wrap">
					...
					<div class="lube-tabs-top-nav-item" data-utabs=1>
						<div class="lube-tabs-top-nav-item-inside">Ресторанно-отельный комплекс ЛЮБЕ</div>
					</div>
					<div class="lube-tabs-top-nav-item" data-utabs=2>
						<div class="lube-tabs-top-nav-item-inside">Отель Любе Плюс</div>
					</div>
				</div>
				<div class="lube-tabs-top-content-wrap">
					<div class="lube-tabs-top-content active" data-utabs=0></div>
					<div class="lube-tabs-top-content" data-utabs=1></div>
					<div class="lube-tabs-top-content" data-utabs=2></div>
				</div>
			</div>
		</div>
